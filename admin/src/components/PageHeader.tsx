...
export function PageHeader({ kicker, title, subtitle, right, back }: Props) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-brand-light/40 dark:border-slate-800 bg-gradient-to-r from-brand-tint via-white to-white dark:from-[#3a1509] dark:via-slate-900 dark:to-slate-900 px-6 py-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-0.5">{title}</h1>
          {subtitle && (
